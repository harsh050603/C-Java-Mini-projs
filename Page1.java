...
public class Page1 {
    ...
    public static void CustomerInfo()
    {
        ...
        String s1[] = { "  ", "Industrial", "Residential", "Commercial","Others" };
            j1 = new JComboBox(s1);
            ...
            // this method is used to save the responses as s txt file 
            b1.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e)
                {
      
                    String s1 = t1.getText();// getText()-- is used to get the data entered in the textfield 
        ...
        b2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                f.dispose();//to perform customized cleanup
            }
        });

        //b3 calculate--> new JFrame will open 
